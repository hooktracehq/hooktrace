...
#     If no provider is configured, use the generic verifier.
#     """
...
#     # IMPORTANT:
#     # Preserve exact raw bytes for signature verification.
#     request.state.raw_body = raw_body
...
#                 #
#                 # NEVER print route_secret.
#                 # --------------------------------------------

#                 print(
#                     "[HOOKTRACE][SIG DEBUG] "
#                     f"timestamp={repr(timestamp)}"
#                 )
...
#                 print(
#                     "[HOOKTRACE][SIG DEBUG] "
#                     f"signature_prefix={signature[:8]!r}"
#                 )
...
#                 print(
#                     "[HOOKTRACE][SIG DEBUG] "
#                     f"raw_body_length={len(raw_body)}"
#                 )

#                 print(
#                     "[HOOKTRACE][SIG DEBUG] "
#                     f"route_secret_length={len(route_secret or '')}"
#                 )
...
from services.shared.redis_client import redis_client
from services.shared.aggregation_dispatcher import (
    dispatch_webhook,
)
