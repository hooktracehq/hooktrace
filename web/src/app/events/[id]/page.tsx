...
//             icon={RotateCcw}
//             label="Attempts"
//             value={(event.attempt_count?? 0 ).toString()}
...
//             icon={Calendar}
//             label="Created"
//             value={formatDistanceToNow(new Date(event.created_at), {
//               addSuffix: true,
//             })}
//           />
//         </div>
...
//                 <h3 className="font-semibold mb-2">Delivery Error</h3>
...
//             <MetaField icon={Hash} label="Event ID" value={event.id.toString()} mono />
//             <MetaField icon={Key} label="Token" value={event.token} mono />
//             <MetaField icon={Globe} label="Route" value={event.route} />
//             <MetaField icon={Zap} label="Provider" value={event.provider || "Generic"} />
//             <MetaField icon={Target} label="Delivery Target" value={event.delivery_target || "Not configured"} />
//             <MetaField icon={Key} label="Idempotency Key" value={event.idempotency_key || "None"} mono />
//             <MetaField icon={Calendar} label="Created At" value={new Date(event.created_at).toLocaleString()} />
//             <MetaField icon={RotateCcw} label="Attempt Count" value={attemptCount.toString()} /> {/* ✅ FIX */}
//           </div>
//         </div>
