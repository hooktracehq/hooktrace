...
function StatusBadge({
  ...
  if (status === "dlq") {
    return (
      <span className="inline-flex shrink-0 items-center rounded-full border border-rose-500/20 bg-rose-500/10 px-1.5 py-0.5 text-[9px] font-medium uppercase tracking-wide text-rose-400">
        dead letter
      </span>
    )
  }
